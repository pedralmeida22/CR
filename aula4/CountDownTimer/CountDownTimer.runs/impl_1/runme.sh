...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula4/CountDownTimer/CountDownTimer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CountDownTimer_part2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CountDownTimer_part2.tcl -notrace
