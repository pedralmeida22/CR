...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula4/CountDownTimer/CountDownTimer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CountDownTimer_part2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CountDownTimer_part2.tcl
