...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula3/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part2_wrapper.tcl
