...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula2/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log part4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source part4_wrapper.tcl -notrace
