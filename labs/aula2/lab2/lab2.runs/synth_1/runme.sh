...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula2/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part4_wrapper.tcl
