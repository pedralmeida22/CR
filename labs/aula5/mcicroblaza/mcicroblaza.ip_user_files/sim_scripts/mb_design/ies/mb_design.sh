...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../mcicroblaza.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../mcicroblaza.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../mcicroblaza.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../mcicroblaza.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
