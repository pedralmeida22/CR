...
HD_PWD='c:/users/pedra/documents/cr/labs/aula9/dma/dma.tmp/reverseendianesscop_v1_0_project/ReverseEndianessCop_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReverseEndianessCop_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReverseEndianessCop_v1_0.tcl
