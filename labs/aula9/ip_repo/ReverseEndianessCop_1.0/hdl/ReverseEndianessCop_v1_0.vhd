...
entity ReverseEndianessCop_v1_0 is
	...
	port (
		...
		s00_axis_tdata	: in std_logic_vector(C_S01_AXIS_TDATA_WIDTH-1 downto 0);
		s00_axis_tstrb	: in std_logic_vector((C_S01_AXIS_TDATA_WIDTH/8)-1 downto 0);
...
architecture arch_imp of ReverseEndianessCop_v1_0 is
	...
	component ReverseEndianessCop_v1_0_S01_AXIS is
		generic (
	...
	end component ReverseEndianessCop_v1_0_S01_AXIS;
...
ReverseEndianessCop_v1_0_S01_AXIS_inst : ReverseEndianessCop_v1_0_S01_AXIS
	generic map (
