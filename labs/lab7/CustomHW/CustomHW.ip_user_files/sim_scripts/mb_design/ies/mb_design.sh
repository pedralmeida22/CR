...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../CustomHW.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CustomHW.gen/sources_1/bd/mb_design/ipshared/d0f7" \
       +incdir+"../../../../CustomHW.gen/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../CustomHW.gen/sources_1/bd/mb_design/ipshared/d0f7"
}
