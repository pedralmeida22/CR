...
HD_PWD='C:/Users/pedra/Desktop/cr/labs/aula3/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log part2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source part2_wrapper.tcl -notrace
